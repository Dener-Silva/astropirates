import { FirstName, SecondName, Input } from 'dtos';
...
export function addPlayer(id: number, firstName: FirstName, secondName: SecondName) {
    ...
    // takenNames.add(name);
    console.log("addPlayer", id, firstName, secondName);
}
